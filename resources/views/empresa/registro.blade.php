...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Registro de Empresa') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('regemp') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                            <label for="apellidos" class="col-md-4 col-form-label text-md-right">{{ __('Distintivo') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" id="CSRF_TOKEN" value="{{csrf_token()}}">
                                ...
                                <span id="email-error" style="color:red; display: none;">Email ya en uso</span>
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback">
